...
def get_gowalla_attacker_config():
    ...
    surrogate_trainer_config = {'name': 'MSETrainer', 'optimizer': 'Adam', 'lr': 0.1, 'l2_reg': 1.e-6,
                                'n_epochs': 9, 'batch_size': 2048,
                                'test_batch_size': 2048, 'topks': [50], 'verbose': False, 'val_interval': 100}
    attacker_config = {'name': 'WRMFSGD', 'lr': 10., 'momentum': 0.95,
    ...
    surrogate_model_config = {'name': 'MF', 'embedding_size': 64, 'verbose': False}
    surrogate_trainer_config = {'name': 'MSETrainer', 'optimizer': 'Adam', 'lr': 0.01, 'l2_reg': 1.e-5,
                                'n_epochs': 10, 'batch_size': 2048,
                                'test_batch_size': 2048, 'topks': [50], 'verbose': False, 'val_interval': 100}
    attacker_config = {'name': 'PGA', 'lr': 1., 'momentum': 0.95,
    ...
    attacker_config = {'name': 'DPA2DL', 'n_fakes': 131, 'topk': 50,
                       'n_inters': 41, 'reg_u': 100., 'prob': 0.9, 'kappa': 1.,
                       'step': 4, 'alpha': 1.e-6, 'n_rounds': 1,
                       'surrogate_model_config': surrogate_model_config,
                       'surrogate_trainer_config': surrogate_trainer_config}
    gowalla_attacker_config.append(attacker_config)
...
def get_yelp_attacker_config():
    ...
    surrogate_model_config = {'name': 'MF', 'embedding_size': 64, 'verbose': False}
    surrogate_trainer_config = {'name': 'MSETrainer', 'optimizer': 'Adam', 'lr': 1.e-3, 'l2_reg': 1.e-5,
                                'n_epochs': 10, 'batch_size': 2048,
                                'test_batch_size': 2048, 'topks': [50], 'verbose': False,
                                'val_interval': 100}
    attacker_config = {'name': 'PGA', 'lr': 10., 'momentum': 0.95,
    ...
    attacker_config = {'name': 'DPA2DL', 'n_fakes': 355, 'topk': 50,
                       'n_inters': 36, 'reg_u': 100., 'prob': 0.9, 'kappa': 1.,
                       'step': 4, 'alpha': 1.e-5, 'n_rounds': 1,
                       'surrogate_model_config': surrogate_model_config,
                       'surrogate_trainer_config': surrogate_trainer_config}
    yelp_attacker_config.append(attacker_config)
...
def get_tenrec_attacker_config():
    ...
    attacker_config = {'name': 'DPA2DL', 'n_fakes': 11952, 'topk': 50,
                       'n_inters': 34, 'reg_u': 100., 'prob': 0.9, 'kappa': 1.,
                       'step': 500, 'alpha': 1.e-7, 'n_rounds': 1,
                       'surrogate_model_config': surrogate_model_config,
                       'surrogate_trainer_config': surrogate_trainer_config}
    tenrec_attacker_config.append(attacker_config)
