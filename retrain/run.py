...
def run_new_items_recall(log_path, seed, lr, l2_reg, gp_proportion, pretrain_weight, pretrain_fixed_dim, n_epochs,
...
def main():
    ...
    run_method = None
    victim_model = None
    jaccard_sim = run_new_items_recall(log_path, seed, lr, l2_reg, gp_proportion, pretrain_weight, pretrain_fixed_dim,
